...
class FinancialsSpider(scrapy.Spider):
    """
    This spider collects the data realting to the financials of a company. It is used in conjuction
    with the status spider to collect all the information for a company besides the 
