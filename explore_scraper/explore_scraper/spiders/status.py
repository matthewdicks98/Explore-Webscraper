...
class StatusSpider(scrapy.Spider):
    """
    This spider collects the data realting to the status of a company. It is used in conjuction
    with the financials spider to collect all the information for a company besides the 
    exectutive data. This spider does not use selenium, instead it just uses scrapy.
    """
    ...
    def parse(self, response):
         """
         This is the scrapy parse function and it is used to scrape the data from the html
         page generated by a url in the start url function.
         """
